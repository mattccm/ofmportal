...
interface SwitchProps extends Omit<SwitchPrimitive.Root.Props, 'render'> {
  className?: string
}
  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block h-5 w-5 rounded-full bg-background shadow-lg ring-0 transition-transform translate-x-0 data-[checked]:translate-x-5"
      />
    </SwitchPrimitive.Root>
  )
}
